...
export class UserController {
  ...
  // @AdminJwtGuard
  @Post('')
  createUser(@Body(CustomValidationPipe) body: CreateUserDto) {
    return this.userService.createUser(body);
  }

  @AdminJwtGuard
  @Delete(':id')
  deleteUserById(@Param('id', new CustomParseIntPipe('id')) id: number) {
  ...
  @AdminJwtGuard
  @Get(':id')
  getUserById(@Param('id', new CustomParseIntPipe('id')) id: number) {
  ...
  getUsersByName(@Param('TenNguoiDung') name: string) {
